  ...
  window.ImageLazyLoad = (function() {
    ...
    function ImageLazyLoad(options) {
      ...
      this.loadAll = function() {
        return ImageLazyLoad.prototype.loadAll.apply(_this, arguments);
      };
    ...
    ImageLazyLoad.prototype.refreshElements = function(position, isWindow) {
      var _this = this;
      return this.$elements = this.$elements.map(function(i, el) {
        var $el, elPos, loadImg;
        $el = $(el);
        elPos = isWindow ? $el.offset()[_this.axis] : $el.position()[_this.axis];
        loadImg = false;
